  ...
  const styles = {
    ...
    ...(autoFit &&
      typeof autoFit === 'object' && {
        gridTemplateColumns: `repeat(auto-fit, minmax(${autoFit.min ??
          '100px'}, ${autoFit.max ?? '1fr'}))`,
      }),
    ...(autoFill &&
    ...
    ...(autoFill &&
      typeof autoFill === 'object' && {
        gridTemplateColumns: `repeat(auto-fill, minmax(${autoFill.min ??
          '100px'}, ${autoFill.max ?? '1fr'}))`,
      }),
  };
  return (
    <AppBox
